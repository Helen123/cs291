...
class AboutSymbols < Neo::Koan
  ...
  #
  # Answer: Symbols are not garbage collected. If you create a large number of unique
  # symbols dynamically, they will stay in memory for the duration of the program's
  # execution, which can lead to memory bloat.
end
