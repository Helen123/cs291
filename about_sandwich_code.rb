...
class AboutSandwichCode < Neo::Koan
  ...
  def test_counting_lines
    assert_equal 4, count_lines("example_file.txt")  # Assuming there are 4 lines in the file
  end
  ...
  def test_finding_lines
    assert_equal "test\n", find_line("example_file.txt")  # Assuming this is the first line containing "e"
  end
  ...
  def test_counting_lines2
    assert_equal 4, count_lines2("example_file.txt")  # Assuming there are 4 lines in the file
  end
  ...
  def test_finding_lines2
    assert_equal "test\n", find_line2("example_file.txt")  # Assuming this is the first line containing "e"
  end
  ...
  def test_open_handles_the_file_sandwich_when_given_a_block
    assert_equal 4, count_lines3("example_file.txt")  # Assuming there are 4 lines in the file
  end
